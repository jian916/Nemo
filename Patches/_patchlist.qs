...
registerPatch(218, "ShowExpNumbers", "顯示經驗條", "介面", 0, "Neo", "在左上角角色狀態欄顯示經驗條", false);
...
registerPatch(350, "ChangeAchievementListPath", "修改AchievementList*.lub路徑", "自訂", 19, "Jian", "勾選後可以輸入自訂的成就 AchievementList*.lub 檔案，如果有官方的更新，可以防止原本的 lub 被覆蓋", false);

registerPatch(351, "ChangeMonsterSizeEffectPath", "修改MonsterSizeEffect*.lub路徑", "自訂", 19, "Jian", "勾選後可以輸入自訂的魔物設定 MonsterSizeEffect*.lub 檔案，如果有官方的更新，可以防止原本的 lub 被覆蓋", false);

registerPatch(353, "ChangeTowninfoPath", "修改Towninfo*.lub路徑", "自訂", 19, "Jian", "勾選後可以輸入自訂的圖標 Towninfo*.lub 檔案，如果有官方的更新，可以防止原本的 lub 被覆蓋", false);

registerPatch(354, "ChangePetEvolutionClnPath", "修改PetEvolutionCln*.lub路徑", "自訂", 19, "Jian", "勾選後可以輸入自訂的生命體 PetEvolutionCln*.lub 檔案，如果有官方的更新，可以防止原本的 lub 被覆蓋", false);

registerPatch(355, "ChangeTipboxPath", "修改Tipbox*.lub路徑", "自訂", 19, "Jian", "勾選後可以輸入自訂的教學 Tipbox*.lub 檔案，如果有官方的更新，可以防止原本的 lub 被覆蓋", false);

registerPatch(356, "ChangeCheckAttendancePath", "修改CheckAttendance*.lub路徑", "自訂", 19, "Jian", "勾選後可以輸入自訂的簽到 CheckAttendance*.lub 檔案，如果有官方的更新，可以防止原本的 lub 被覆蓋", false);

registerPatch(357, "ChangeOngoingQuestInfoListPath", "修改OngoingQuestInfoList*路徑", "自訂", 19, "Jian", "勾選後可以輸入自訂的任務 OngoingQuestInfoList* 檔案，如果有官方的更新，可以防止原本的 lub 被覆蓋", false);

registerPatch(358, "ChangeRecommendedQuestInfoListPath", "修改RecommendedQuestInfoList*路徑", "自訂", 19, "Jian", "勾選後可以輸入自訂的任務 RecommendedQuestInfoList* 檔案，如果有官方的更新，可以防止原本的 lub 被覆蓋", false);

registerPatch(359, "ChangePrivateAirplanePath", "修改PrivateAirplane*.lub路徑", "自訂", 19, "Jian", "勾選後可以輸入自訂的飛空艇 PrivateAirplane*.lub 檔案，如果有官方的更新，可以防止原本的 lub 被覆蓋", false);
