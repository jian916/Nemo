...
//        floatToHex(0.0005);
    ...
    var code =
        ...
        "E8 ?? ?? ?? ?? " +           // 5 call CSession_sub_AA0510
        "83 EC 08 " +                 // 10 sub esp, 8
        "3C 01 " +                    // 13 cmp al, 1
        "8B 45 ?? " +                 // 15 mov eax, [ebp+a2]
        "8B CF " +                    // 18 mov ecx, edi
        "75 25 " +                    // 20 jnz short loc_A67326
        "F3 0F 10 45 ?? " +           // 22 movss xmm0, [ebp+y]
        "F3 0F 11 44 24 ?? " +        // 27 movss [esp+20Ch+A], xmm0
        "F3 0F 10 45 ?? " +           // 33 movss xmm0, [ebp+x]
        "F3 0F 11 04 ?? " +           // 38 movss [esp+20Ch+B], xmm0
        "56 " +                       // 43 push esi
        "50 " +                       // 44 push eax
        "8D 85 ?? ?? ?? ?? " +        // 45 lea eax, [ebp+spr]
        "50 " +                       // 51 push eax
        "E8 ?? ?? ?? ?? " +           // 52 call CRenderObject_RenderSprite2
        "EB 1D " +                    // 57 jmp short loc_A67343
        "C7 44 24 ?? 00 00 00 00 " +  // 59 mov [esp+20Ch+A], 0
        "C7 04 ?? 00 00 00 00 " +     // 67 mov [esp+20Ch+B], 0
        "56 " +                       // 74 push esi
        "50 " +                       // 75 push eax
        "8D 85 ?? ?? ?? ?? " +        // 76 lea eax, [ebp+spr]
        "50 " +                       // 82 push eax
    ...
    if (offsets.length === 0)
    {
        var code =
            getEcxSessionHex() +          // 0 mov ecx, offset g_session
            "E8 ?? ?? ?? ?? " +           // 5 call CSession_sub_ADB710
            "3C 01 " +                    // 10 cmp al, 1
            "75 2D " +                    // 12 jnz short loc_AA1DED
            "F3 0F 10 45 ?? " +           // 14 movss xmm0, [ebp+var_68]
            "8B 45 ?? " +                 // 19 mov eax, [ebp+pal]
            "83 EC 08 " +                 // 22 sub esp, 8
            "8B CF " +                    // 25 mov ecx, edi
            "F3 0F 11 44 24 ?? " +        // 27 movss [esp+1B0h+A], xmm0
            "F3 0F 10 45 ?? " +           // 33 movss xmm0, [ebp+var_64]
            "F3 0F 11 04 ?? " +           // 38 movss [esp+1B0h+B], xmm0
            "56 " +                       // 43 push esi
            "50 " +                       // 44 push eax
            "8D 85 ?? ?? ?? ?? " +        // 45 lea eax, [ebp+spr]
            "50 " +                       // 51 push eax
            ...
            "83 7D ?? ?? " +              // 59 cmp [ebp+a3], 1
            "75 25 " +                    // 63 jnz short loc_AA1E18
            "0F BE 45 ?? " +              // 65 movsx eax, [ebp+a4]
            "48 " +                       // 69 dec eax
            ...
            "8B 45 ?? " +                 // 102 mov eax, [ebp+pal]
            "83 EC 08 " +                 // 105 sub esp, 8
            "8B CF " +                    // 108 mov ecx, edi
            "C7 44 24 ?? 00 00 00 00 " +  // 110 mov [esp+1B0h+A], 0
            "C7 04 ?? 00 00 00 00 " +     // 118 mov [esp+1B0h+B], 0
            "56 " +                       // 125 push esi
            "50 " +                       // 126 push eax
            "8D 85 ?? ?? ?? ?? " +        // 127 lea eax, [ebp+spr]
            "50 " +                       // 133 push eax
    ...
    code =
        ...
        "89 9D ?? ?? ?? ?? " +        // 5 mov [ebp+cnt], ebx
        "8B 4F ?? " +                 // 11 mov ecx, [edi+38h]
        "8B 57 ?? " +                 // 14 mov edx, [edi+3Ch]
        "8B C1 " +                    // 17 mov eax, ecx
        "2B 47 ?? " +                 // 19 sub eax, [edi+34h]
