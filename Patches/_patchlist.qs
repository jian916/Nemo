...
registerPatch( 316, "MainHighlight", "Highlight Chat Color", "Color", 0, "Hanashi", "Changes the highlight chat color and sets it to the specified value. Default value is #CADFFB (Hawkes Blue)", false);
