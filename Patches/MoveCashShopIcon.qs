...
function MoveCashShopIcon()
{
    ...
    consoleLog("Step 1c - Find the pattern where the Screen Size is picked up (Width is at 0x24, Height is at 0x28) - We need the address of g_ScreenStats");
    code =
    ...
    {
        code =
            " A1 ?? ?? ?? 00" +  // MOV EAX, DWORD PTR DS:[g_ScreenStats]
            " 8B";               // MOV reg32_A, DWORD PTR DS:[reg32_B+const]
    ...
    consoleLog("Step 1d - Extract the g_ScreenStats");
    ...
    consoleLog("Step 2c - Allocate space for it");
