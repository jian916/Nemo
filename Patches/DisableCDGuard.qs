...
function DisableCDGuard()
{
    ...
    var code =
        "8B 0D AB AB AB AB " +  // 00 mov ecx, g_CCheatDefenderMgr
        "E8 AB AB AB AB " +     // 06 call CCheatDefenderMgr_init
        "3C 01 " +              // 11 cmp al, 1
        "A1 AB AB AB AB " +     // 13 mov eax, g_CCheatDefenderMgr
        "0F 94 C1 " +           // 18 setz cl
        "68 AB AB AB AB " +     // 21 push offset string_buffer
    ...
    if (offsets.length === 0)
    {
        code =
            ...
            "3C 01 " +              // 11 cmp al, 1
            "A1 AB AB AB AB " +     // 13 mov eax, g_CCheatDefenderMgr
            "68 AB AB AB AB " +     // 18 push offset g_zoneServerAddr
            "0F 94 C1 " +           // 23 setz cl
            "88 48 05 " +           // 26 mov [eax+5], cl
            "E8 AB AB AB AB " +     // 29 call CRagConnection_instanceR
            "8B C8 " +              // 34 mov ecx, eax
    ...
    var code =
        ...
        "B8 AB AB AB 00 ";           // 08 mov eax, CZ_ENTER
